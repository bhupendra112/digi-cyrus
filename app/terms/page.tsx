    ...
    <>
      ...
      <article className="bg-white py-16 text-black">
        ...
        <div className="max-w-none space-y-8 text-zinc-600">
          ...
          <section>
            <h2 className="text-xl font-semibold text-black">1. Agreement to Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-black">2. Services</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-black">3. Use of Website</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-black">5. Confidentiality</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-black">7. Governing Law</h2>
            <p>
