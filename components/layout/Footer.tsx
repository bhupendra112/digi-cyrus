        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link href="/terms" className="text-sm text-zinc-300 transition hover:text-gold">
                  Terms &amp; Conditions
                </Link>
              </li>
              <li>
                <Link href="/privacy" className="text-sm text-zinc-300 transition hover:text-gold">
                  Privacy Policy
                </Link>
              </li>
            </ul>
